...
import com.mycompany.presupuestoferias.ejercicios.ArbolBinario;
import com.mycompany.presupuestoferias.ejercicios.BusquedaBinaria;
import com.mycompany.presupuestoferias.ejercicios.HashTable;
import com.mycompany.presupuestoferias.ejercicios.Grafos;
...
public class Ejercicios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnGrafos = new javax.swing.JButton();
        ...
        jPanel6.add(btnBusquedaBinaria, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 50, 180, 70));

        btnGrafos.setText("GRAFOS");
        btnGrafos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnGrafosActionPerformed(evt);
            }
        });
        jPanel6.add(btnGrafos, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 320, 180, 70));

        btnHashTable.setText("HASH TABLE");
        btnHashTable.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnHashTableActionPerformed(evt);
            }
        });
        jPanel6.add(btnHashTable, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 140, 180, 70));

        btnArbolBinario.setText("ÁRBOL BINARIO");
        btnArbolBinario.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnArbolBinarioActionPerformed(evt);
            }
        });
        jPanel6.add(btnArbolBinario, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 230, 180, 70));
        ...
        jTabbedPane1.addTab("Ejercicios Finales", jPanel4);
    ...
    private void btnBusquedaBinariaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBusquedaBinariaActionPerformed
        BusquedaBinaria busbina = new BusquedaBinaria();
        busbina.main(new String[0]);
    }//GEN-LAST:event_btnBusquedaBinariaActionPerformed

    private void btnGrafosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGrafosActionPerformed
        ...
        int[][] edgesArray = new int[numEdges][2];
        System.out.println("Ingrese las aristas (origen y destino):");
        for (int i = 0; i < numEdges; i++) {
            int source = scanner.nextInt();
            int destination = scanner.nextInt();
            edgesArray[i][0] = source;
            edgesArray[i][1] = destination;
        }
        ...
        graf.initialize(numVertices, numEdges, startVertex, edgesArray);
    }//GEN-LAST:event_btnGrafosActionPerformed

    private void btnHashTableActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHashTableActionPerformed
        HashTable hash = new HashTable();
        hash.main(new String[0]);
    ...
    private javax.swing.JButton btnGrafos;
