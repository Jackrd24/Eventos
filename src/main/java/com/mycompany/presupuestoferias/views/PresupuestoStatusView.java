...
public class PresupuestoStatusView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtPresupuestoCalculado = new javax.swing.JTextField();
        ...
        jPanel1.add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 100, 730, 130));
        ...
        jLabel11.setText("PRESUPUESTO CALCULADO (S/.)");
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 170, -1, -1));

        txtPresupuestoCalculado.setEditable(false);
        txtPresupuestoCalculado.setFont(new java.awt.Font("Roboto", 1, 24)); // NOI18N
        txtPresupuestoCalculado.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtPresupuestoCalculadoActionPerformed(evt);
            }
        });
        jPanel1.add(txtPresupuestoCalculado, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 200, 220, 40));

        txtMontoFeria.setEditable(false);
        txtMontoFeria.setFont(new java.awt.Font("Roboto", 1, 24)); // NOI18N
        jPanel1.add(txtMontoFeria, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 120, 220, 40));

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(0, 0, 0));
        jLabel10.setText("MONTO DE INVERSIÓN INICIAL (S/.)");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 90, -1, -1));
    ...
    private void txtPresupuestoCalculadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtPresupuestoCalculadoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtPresupuestoCalculadoActionPerformed
    ...
    public javax.swing.JTextField txtPresupuestoCalculado;
